...
let joey   = document.querySelector('.fb_joey');
...
const animeren = () => {
    ...
    setTimeout( () => {joey.classList.remove('fb--uit')}, 300);
    ...
    setTimeout( () => {tut.classList.add('fb--uit')}, 2200);

    //logos//
    setTimeout( () => {html.classList.remove('fb--uit')}, 2600);
    setTimeout( () => {css.classList.remove('fb--uit')}, 2800);
    setTimeout( () => {js.classList.remove('fb--uit')}, 3200);
